...
export default function Home() {
  ...
  return (
    ...
    <main className={`${currentData == null ? "blur-md" : ""} `}>
      ...
      />
      <section className="grid grid-cols-[repeat(auto-fit,160px)] gap-2 justify-center p-4">
      ...
      <table className="w-full max-w-[1160px] m-auto mt-10 text-center border-spacing-0">
        <tbody>
