...
export default function Search({
  ...
  return (
    <div className="w-full max-w-[640px] flex flex-col justify-center bg-background-box mb-10 mt-6 p-6 gap-4 mx-auto md:flex-row">
      <div className="flex flex-col">
        <label className="text-xs text-foregroundColor font-bold mb-1">
          Search City
        </label>
        <input
          className="rounded-md outline-none p-2 text-sm placeholder:text-xs bg-background-board"
